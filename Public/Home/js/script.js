var App = function () {
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"http://127.0.0.1:8000/PHPWebSite/WebFinal/MyWallet/Public/Home/img/login/1.jpg"
		, "http://127.0.0.1:8000/PHPWebSite/WebFinal/MyWallet/Public/Home/img/login/2.jpg"
		, "http://127.0.0.1:8000/PHPWebSite/WebFinal/MyWallet/Public/Home/img/login/3.jpg"
		, "http://127.0.0.1:8000/PHPWebSite/WebFinal/MyWallet/Public/Home/img/login/4.jpg"
	...
	return {
        ...
        init: function () {
			...
			if (App.isPage("login_bg")) {
				handleUniform();	//Function to handle uniform inputs
				handleBackstretch();	//Function to handle background img
			}
			if (App.isPage("chats")) {
				handleChat('chat-window');	//Function to handle chat
